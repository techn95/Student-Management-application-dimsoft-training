...
public class ValidationMessage {
    ...
    public static class Subject{
        public static final String SUBJECT_INTITULE_NOT_EMPTY = "Subject intitule can not be empty";
        public static final String SUBJECT_INTITULE_NOT_NULL = "Subject intitule can not be null";
        public static final String SUBJECT_COEFFICIENT_NOT_EMPTY = "Subject coefficient can not be empty";
        public static final String SUBJECT_COEFFICIENT_NOT_NULL = "Subject coefficient can not be null";
    }

    public static class StudentSubject {
        public static final String STUDENTSUBJECT_YEAR_NOT_EMPTY = "StudentSubject year can not be empty";
        public static final String STUDENTSUBJECT_YEAR_NOT_NULL = "StudentSubject year can not be null";
        public static final String STUDENTSUBJECT_NOTE_NOT_EMPTY = "StudentSubject note can not be empty";
        public static final String STUDENTSUBJECT_NOTE_NOT_NULL = "StudentSubject note can not be null";
        public static final String STUDENTSUBJECT_SUBJECT_NOT_EMPTY = "StudentSubject Subject can not be empty";
        public static final String STUDENTSUBJECT_SUBJECT_NOT_NULL = "StudentSubject Subject can not be null";
        public static final String STUDENTSUBJECT_STUDENT_NOT_EMPTY = "StudentSubject Student can not be empty";
        public static final String STUDENTSUBJECT_STUDENT_NOT_NULL = "StudentSubject Student can not be null";
    }
}
